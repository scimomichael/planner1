...
- add_block: {type:"add_block", date, label, blockType, start, end, due?, classLabel?, description?, recur?, recurUntil?, priority?, location?, link?}
- update_block: {type:"update_block", date, index, label?, start?, end?, due?, classLabel?, description?, blockType?, recur?, done?, priority?, location?, link?}
